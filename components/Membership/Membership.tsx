...
const Membership = () => {
  ...
  return (
    <div
      className="mt-6 grid grid-cols-1 gap-x-4 border px-4
    ...
    >
      <div className="space-y-2 py-4">
        ...
        <button
          ...
          text-sm font-medium text-black shadow-md hover:bg-gray-200 md:w-4/5"
      ...
      <div className="col-span-3">
        ...
        <div
          className="flex flex-col justify-between pt-4 pb-4
          md:flex-row md:pb-0"
        >
          <div>
            <p>
